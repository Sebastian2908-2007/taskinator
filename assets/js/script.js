...
if (targetEl.matches(".edit-button")) {
...
// this function should 1. get task items from local storage
//convert tasks from the string format back to the array of objects
